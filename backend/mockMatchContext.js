 ...
 * Contains details for multiple FIFA 2026 matches.
 */
const mockMatchContext = {
  ...
  "fifa_2026_002": {
    ...
    "liveData": {
      ...
      "attendance": 70240,
      "temperature": "18°C (Roof Closed)"
    },
    "recentEvents": [
      { "minute": 5, "type": "GOAL", "team": "home", "player": "Mbappe", "description": "Quick rebound shot after Griezmann's blocked attempt in the penalty box." },
      { "minute": 21, "type": "YELLOW_CARD", "team": "away", "player": "Amrabat", "description": "Tactical foul halting a counterattack by Dembele." },
      { "minute": 38, "type": "VAR_REVIEW", "decision": "No Penalty", "description": "Referee checked VAR screen for a potential handball in the French penalty box but ruled it accidental." }
    ],
    "rules": {
      "offside": "A player is in an offside position if they are nearer to the opponent's goal line than both the ball and the second-last opponent (usually the last defender) at the moment the ball is played to them, unless they are in their own half.",
      "var": "Video Assistant Referee (VAR) reviews four types of game-changing decisions: Goals/no goals, Penalty/no penalty, Direct red card (not second yellow), and Mistaken identity. The VAR can only assist when a 'clear and obvious error' or 'serious missed incident' occurs.",
